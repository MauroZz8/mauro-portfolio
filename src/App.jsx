  ...
  return (
    <div id="home" className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased selection:bg-indigo-500 selection:text-white">
      ...
      <header className="max-w-5xl mx-auto px-4 pt-44 pb-24 text-center md:text-left">
        ...
        {/* Pulsanti di Contatto/Social sotto la descrizione */}
        <div className="flex flex-wrap gap-4 justify-center md:justify-start items-center">
          ...
          >
            {/* Icona Minimal di LinkedIn via SVG */}
          ...
          <a href="#progetti" className="text-sm font-semibold text-slate-400 hover:text-indigo-400 ml-2 transition-colors">
            Scopri i miei lavori &rarr;
          </a>
        </div>
      </header>
      ...
      {/* FOOTER */}
      <footer id="contatti" className="py-16 text-center text-slate-600 text-sm border-t border-slate-900 mt-20 bg-slate-950">
